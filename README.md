...
HashSeq infers true biological 16 rRNA sequences from background error.
...
Specify the input directory which includes sequences, output directory,
and a filtering threshold where it is used to remove low abundant
sequence variants.
...
#> [2] "Class Path: /private/var/folders/xy/_t9k7cp17rlf0j7xk3l006zh0000gn/T/RtmpJ1r2fC/temp_libpatha9b86ba62b93/HashSeq/extdata/SequenceVariant.jar"
...
Visualize the mean and standard deviation of one-mismatch variants:
